...
def _load_package(required_symbols):
    """Locate the matching runtime from a release bundle or owned installation."""
...
def main(argv=None) -> int:
    ...
    try:
        runtime = _load_package(("validate_project",))
        report = runtime.validate_project(Path(args.project_dir))
    except Exception as error:
        if args.as_json:
            print(
                json.dumps(
